...
#    define __SWAP_LONGLONG(l)                                                                                                \
        ((((l) >> 56) & 0x00000000000000FFLL) | (((l) >> 40) & 0x000000000000FF00LL) | (((l) >> 24) & 0x0000000000FF0000LL) | \
         (((l) >> 8) & 0x00000000FF000000LL) | (((l) << 8) & 0x000000FF00000000LL) | (((l) << 24) & 0x0000FF0000000000LL) |   \
...
enum ws_head_len { SHORT_HEADER = 6, MEDIUM_HEADER = 8, LONG_HEADER = 14, INVALID_HEADER };

enum ws_send_state { SND_CONTINUATION = 1, SND_NO_FIN = 2, SND_COMPRESSED = 64 };
